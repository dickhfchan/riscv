//! Ferrite OS IPC server process — Phase 9.
//!
//! Ecall convention:
...
pub unsafe extern "C" fn _start() -> ! {
    // Block until client sends a message.
    let (_err, _badge, msg0, _) = ecall(SLOT_ENDPOINT, ENDPOINT_RECV, 0, 0, 0, 0);
    ...
    // Reply with msg0 * 2.
    ecall(0, ENDPOINT_REPLY, msg0 * 2, 0, 0, 0);
